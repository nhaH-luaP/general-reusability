...
eval_model=${models[$index / 4 % 4]}
query=${queries[$index / 16 % 5]}
seed=${random_seeds[$index / 80]}
...
output_dir=/mnt/stud/work/phahn/SDAL/output/eval_reu/${eval_model}/${query_model}/${query}/seed_${seed}/
