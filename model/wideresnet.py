...
def WideResnet2810(n_classes=10, dropout_rate=0.0, imagenethead=False):
    model = WideResNet(depth=28, widen_factor=10, dropout_rate=dropout_rate, num_classes=n_classes,
                       imagenethead=imagenethead)
    return model


def WideResnet282(n_classes=10, dropout_rate=0.0, imagenethead=False):
    model = WideResNet(depth=28, widen_factor=2, dropout_rate=dropout_rate, num_classes=n_classes,
                       imagenethead=imagenethead)
    return model
